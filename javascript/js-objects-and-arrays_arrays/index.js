...
// exampleArray.splice(0, 0, "String", 35);
...
// petsWithPush.push(petsWithPush.at(-1)) = "rat";
...
// names.splice(0, 0, "Marie", "Johannes", "Erwan");
// console.log(names);
...
// let namesTwo = [names.shift(2)];
// console.log(names, namesTwo);

// namesTwo.push("Harald");
// console.log(names, namesTwo);
