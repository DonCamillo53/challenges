...
const hippoExists = animalStrings.find((animal) => animal.startsWith("hi"));
console.log(hippoExists);

// Hint: You can pass the starting index as second parameter.
const catStartingFromIndexFiveExists = animalStrings.find((animal) =>
  animal.startsWith("cat", 5)
);

const testSearch = animalStrings.find((animal) => animal.includes("bra"));
